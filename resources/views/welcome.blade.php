        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, {{ date('Y') }} <a href="#">Chef's Palate.</a> <strong> Developed &amp; <i class="far fa-heart"></i> by </strong>
                        <a href=# target="_blank">Mahin Islam Provat</a>
                    </p>
                </div>
            </div>
        </div>
